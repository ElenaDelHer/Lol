...
const startChampionList = async ()=>{
    try {
        ...
        for(let championId in data.data){
            ...
            const champion = new (0, _championJsDefault.default)(championData);
        ...
        alert("Hubo un problema al cargar los campeones. Intenta m\xe1s tarde.");
    }
};
...
},{"./Champion.js":"97VM6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"97VM6":[function(require,module,exports,__globalThis) {
